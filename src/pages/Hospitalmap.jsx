...
const HospitalMap = () => {
  ...
  const fetchHospitals = async () => {
    try {
      const response = await axios.get("https://myhospitalsapi.aihw.gov.au/api/v0/retired-myhospitals-api/hospitals");
  ...
  const defaultCenter = userLocation || { lat: -33.8688, lng: 151.2093 };
